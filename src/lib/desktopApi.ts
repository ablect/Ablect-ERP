...
export type LicenseStatus={valid:boolean;reason:string;machineId?:string;licenseId?:string;customerName?:string;expiresAt?:string};
export type SetupStatus={needsSetup:boolean;users:number;products:number;hardwareConfigured:boolean;businessName:string};
