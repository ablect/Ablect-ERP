...
declare global {
  ...
  interface Window {
    ablectDesktop?: {
      ...
      auth: {
        login: (identifier: string, password: string) => Promise<AblectAuthSession>;
        validate: (token: string) => Promise<AblectAuthSession["user"] | null>;
      ...
      erp: {
        ...
        crm: { opportunities: () => Promise<unknown[]>; activities: () => Promise<unknown[]> };
