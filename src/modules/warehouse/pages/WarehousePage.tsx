...
export default function WarehousePage() {
  ...
  return <PageContainer><div className="min-h-full space-y-6 bg-[#f8fafc] pb-10 text-slate-900">
    ...
    <section className="grid gap-4 sm:grid-cols-3"><Metric icon={WarehouseIcon} label="Locations" value={warehouses.length}/><Metric icon={Boxes} label="Total capacity" value={totalCapacity.toLocaleString()}/><Metric icon={Package} label="Units recorded" value={totalStock.toLocaleString()}/></section>
